...
use bitcoin::{
    bip32::{DerivationPath, ExtendedPrivKey, Fingerprint, Xpub},
    psbt::Psbt,
    secp256k1::Secp256k1,
...
use oxivault_core::{
    multisig::{
        CosignerInfo, MultisigBuilder, MultisigConfig, MultisigScriptType, PsbtCoordinator,
    },
    Network,
};
...
fn test_invalid_multisig_config() {
    ...
    let result = MultisigConfig::new(11, cosigners, Network::Bitcoin, MultisigScriptType::P2wsh);
    assert!(result.is_err());
}
