//! Integration tests for OxiVault core functionality

use bitcoin::OutPoint;
use oxivault_core::{
    bip32::{DerivationPaths, HdWallet},
...
fn test_deterministic_addresses() {
    ...
    for i in 0..5 {
        let addr1 = wallet1
            .get_address(ScriptType::NativeSegwit, 0, 0, i)
            .unwrap();
        let addr2 = wallet2
            .get_address(ScriptType::NativeSegwit, 0, 0, i)
            .unwrap();
...
fn test_account_xpub() {
    ...
    let account_xpub = wallet
        .get_account_xpub(ScriptType::NativeSegwit, 0)
        .unwrap();
