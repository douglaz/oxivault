...
mod tests {
    ...
    fn test_wallet_creation_from_mnemonic() {
        ...
        let wallet =
            Wallet::from_mnemonic(mnemonic, "", Network::Bitcoin).expect("Failed to create wallet");
    ...
    fn test_address_derivation_all_types() {
        ...
        // Test Legacy (P2PKH)
        let legacy = wallet
            .get_address(ScriptType::Legacy, 0, 0, 0)
        ...
        let nested = wallet
            .get_address(ScriptType::NestedSegwit, 0, 0, 0)
        ...
        // Test Taproot (P2TR)
        let taproot = wallet
            .get_address(ScriptType::Taproot, 0, 0, 0)
    ...
    fn test_multiple_addresses_from_same_wallet() {
        ...
        let addr1 = wallet
            ...
            .unwrap();
        let addr2 = wallet
            .get_address(ScriptType::NativeSegwit, 0, 0, 1)
            .unwrap();
        let addr3 = wallet
            .get_address(ScriptType::NativeSegwit, 0, 0, 2)
            .unwrap();
    ...
    fn test_change_addresses() {
        ...
        let internal = wallet
            .get_address(ScriptType::NativeSegwit, 0, 1, 0)
            .unwrap();
    ...
    fn test_different_accounts() {
        ...
        // Account 1
        let account1 = wallet
            .get_address(ScriptType::NativeSegwit, 1, 0, 0)
            .unwrap();
    ...
    fn test_network_separation() {
        ...
        let mainnet_addr = mainnet_wallet
            .get_address(ScriptType::NativeSegwit, 0, 0, 0)
            .unwrap();
        ...
        let testnet_addr = testnet_wallet
            .get_address(ScriptType::NativeSegwit, 0, 0, 0)
            .unwrap();
    ...
    fn test_passphrase_support() {
        ...
        let wallet_no_pass =
            Wallet::from_mnemonic(mnemonic, "", Network::Bitcoin).expect("Failed to create wallet");
        let addr_no_pass = wallet_no_pass
            .get_address(ScriptType::NativeSegwit, 0, 0, 0)
            .unwrap();
        ...
        let addr_with_pass = wallet_with_pass
            .get_address(ScriptType::NativeSegwit, 0, 0, 0)
            .unwrap();
