//! Terminal User Interface for IronVault simulator
...
impl Default for App {
    fn default() -> Self {
        Self {
            ...
            selected_index: 0,
            input: String::new(),
            status: "Welcome to IronVault Simulator".to_string(),
            should_quit: false,
            qr_display: None,
            bbqr_parts: Vec::new(),
            bbqr_index: 0,
...
impl App {
    ...
    fn draw(&mut self, f: &mut Frame) {
        ...
        // Title
        let title = Paragraph::new("IronVault Hardware Wallet Simulator")
    ...
    fn draw_about(&self, f: &mut Frame, area: Rect) {
        let text = vec![
            Line::from("IronVault - Next-Generation Rust Hardware Wallet"),
            Line::from(""),
